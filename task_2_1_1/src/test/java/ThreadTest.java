...
class PrimeCheckTest {
    ...
    public void simpleTest() {
        ...
        assertFalse(SimpleSort.hasprime(enlargedTestArray));
    }
    ...
    public void threadTest2() throws Exception {
        ...
        assertFalse(ThreadSort.threadRun(enlargedTestArray, 2));
    ...
    public void threadTest4() throws Exception {
        ...
        assertFalse(ThreadSort.threadRun(enlargedTestArray, 4));
    ...
    public void threadTest8() throws Exception {
        ...
        assertFalse(ThreadSort.threadRun(enlargedTestArray, 8));
    ...
    public void threadTest16() throws Exception {
        ...
        assertFalse(ThreadSort.threadRun(enlargedTestArray, 16));
    ...
    public void streamTest() {
        ...
        assertFalse(StreamSort.streamRun(testArrayLong));
    }
}